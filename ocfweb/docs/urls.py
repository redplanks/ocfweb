    ...
    for doc in chain(
        [
            Document(name='/about/officers',
                     title='Officers', render=officers).save(),
            Document(name='/staff/backend/servers',
                     title='Servers', render=servers).save(),
            Document(name='/staff/backend/stretch',
                     title='Debian Stretch upgrade', render=stretch_upgrade).save(),
            Document(name='/services/account/account-policies',
                     title='Account policies', render=account_policies).save(),
            Document(name='/services/vhost/badges',
                     title='Hosting badges', render=hosting_badges).save(),
            Document(name='/services/lab',
                     title='Computer lab', render=lab).save(),
            Document(name='/services/shell/commands',
                     title='Command reference', render=commands).save(),
        ],
        get_markdown_docs(),
    )
}
